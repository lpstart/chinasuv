...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span9">
				<h2 class="page-title">所有的角色</h2>
				<div class="btn-toolbar">
					<a href="manage/addRole.jdo">
				...
				<div class="well">
					<table id="roleTable" class="table table-striped table-bordered"
						...
						<tbody>
							<c:forEach items="${allRole }" var="temp">
								<tr>
									<td>${temp.id }</td>
									<td>${temp.roleremark }</td>
									<td>${temp.roledescription }</td>
									<td>
										<a href="manage/menuAllocate.jdo?id=${temp.id }"> 分配菜单 </a>
									</td>
									<td>
										<a href="manage/editRole.jdo?id=${temp.id }">
											<i class="icon-pencil"></i>
										</a>
										<a href="manage/deleteRole_do.jdo?id=${temp.id }" role="button"
											data-toggle="modal">
