...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" style="margin: 0px">
			<div class="row">
				<div class="col-lg-8">
					<h2 class="page-header" style="margin: 5px;">编辑角色</h2>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<form role="form" action="manage/editRole_do.jdo" method="post">
										<input type="hidden" value="${role.id }" name="id">
										<div class="form-group">
											<label>角色名：</label>
											<input class="form-control" value="${role.roleremark }" name="roleremark">
											<p class="help-block">通过这个页面来实现这个菜单的功能。</p>
										</div>
										<div class="form-group">
											<label>角色描述：</label>
											<input class="form-control" value="${role.roledescription }" name="roledescription">
											<p class="help-block">描述这个角色的功能。</p>
										</div>
										<br /> <br />
