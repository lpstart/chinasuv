...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" style="margin: 0px">
			<div class="row">
				<div class="col-lg-8">
					<h2 class="page-header" style="margin: 5px;">添加用户</h2>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<form role="form" action="manage/addUser_do.jdo" method="post">
										<label>用户名：</label>
										<div class="input-group">
											<span class="input-group-addon" id="basic-addon1" style="color: red">*</span> <input
												class="form-control" placeholder="用户名" name="username" type="text"
												style="width: 70%" aria-describedby="basic-addon1">
										</div>
										<label>邮箱：</label>
										<div class="input-group">
											<span class="input-group-addon" id="basic-addon1" style="color: red">*</span> <input
												class="form-control" placeholder="E-mail" name="email" style="width: 70%"
												aria-describedby="basic-addon1" type="email">
										</div>
										<label>密码：</label>
										<div class="input-group">
											<span class="input-group-addon" id="basic-addon1" style="color: red">*</span> <input
										...
										<div class="form-group">
											...
											<div class="radio-inline">
												<label> <input type="radio" name="gender" id="optionsRadios1"
													value="woman"> 女
												</label>
											</div>
											<div class="radio-inline">
												<label> <input type="radio" name="gender" id="optionsRadios2"
													value="man" checked> 男
												</label>
											</div>
										</div>
										<div class="form-group">
											<label>联系方式：</label> <input class="form-control" placeholder="电话号码.."
												name="phonenumber">
										</div>
										<div class="form-group">
											<label>用户描述：</label> <input class="form-control" placeholder="描述.."
												name="description">
