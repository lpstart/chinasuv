				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<form role="form" action="manage/editMenu_do.jdo" method="post">
										<input type="hidden" value="${menu.id }" name="id">
										<input type="hidden" value="${menu.level }" name="level">
										<input type="hidden" value="${menu.seq }" name="seq">
										<div class="form-group">
											<label>菜单名：</label>
											<input class="form-control" id="disabledInput" type="text" readonly="readonly"
												name="menuremark" value="${menu.menuremark }">
											<p class="help-block">用于命名这个菜单。</p>
										</div>
										<div class="form-group">
											<label>管理页面地址：</label>
											<input class="form-control" value="${menu.location }" name="location">
											<p class="help-block">通过这个页面来实现这个菜单的功能。</p>
										</div>
										<div class="form-group">
											<label for="disabledSelect">选择父菜单</label>
											<select id="disabledSelect" class="form-control" name="parent_id">
												<option value="${menu.parent_id}">${parentMenuName}</option>
											</select>
										</div>
								<br /> <br />
