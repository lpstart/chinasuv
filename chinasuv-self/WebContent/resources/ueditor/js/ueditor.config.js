...
(function() {
	...
	/**
	 * 配置项主体。注意，此处所有涉及到路径的配置别遗漏URL变量。wanglipeng
	 */
	window.UEDITOR_CONFIG = {
		...
		toolbars : [ [ 'fullscreen', 'source', '|', 'undo', 'redo', '|',
				...
				'insertimage', 'emotion', 'music', 'attachment', 'map', 'gmap',
				'insertcode', 'pagebreak', 'background', '|', 'horizontal',
				'date', 'time', 'spechars', '|', 'inserttable', 'deletetable',
