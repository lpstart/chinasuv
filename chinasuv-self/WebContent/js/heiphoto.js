...
var epidiascope = {
	...
	init : function(){
		...
		this._imgLoad = function(){
			...
			if(this.width < 958){
				...
				this.style.borderBottom = "1px solid #1c1f1f";
			};
	...
	listSelect : function(num){
		...
		if(this.listSelectedIndex !== null){
			this.listData[this.listSelectedIndex].className = 'aPicBox';
		};
		this.listSelectedIndex = num;
		this.listData[this.listSelectedIndex].className = 'aPicBox selected';
	},
	listInit : function(){
		var tempThis = this;
		this.listData = [];
